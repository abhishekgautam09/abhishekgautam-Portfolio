  ...
  return (
    <section className="w-full py-12 px-6" ref={ref}>
      <div className="max-w-4xl ml-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          <p className="text-[#E0EBF0] text-xs font-mono mt-4 mb-6">01</p>
          <h3 className="text-[22px] font-medium text-[#F6FCFF] mb-3">Product UX</h3>
          <p className="text-sm text-[#E0EBF0] mb-6 leading-relaxed">
          ...
          <ul className="text-sm text-[#E0EBF0] mb-8 space-y-2">
        ...
        >
          <p className="text-[#051A24]/40 text-xs font-mono mt-4 mb-6">02</p>
          <h3 className="text-[22px] font-medium text-[#0D212C] mb-3">Web & Brand</h3>
          <p className="text-sm text-[#051A24]/70 mb-6 leading-relaxed">
            Landing pages, responsive websites, and brand systems.<br />
            From early concept to polished, shippable design.
          </p>
          <ul className="text-sm text-[#051A24]/70 mb-8 space-y-2">
